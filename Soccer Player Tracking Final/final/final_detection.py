...
def process_detections(model_path, test_dir, results_dir=None, detections_dir=None, conf_threshold=0.5):
    """Process images with YOLO model and save detection results."""
...
def main():
    ...
    test_dir = os.path.join(current_dir, 'final', 'extracted_frames')
    results_dir = os.path.join(current_dir, 'final', 'detection_results')
    detections_dir = os.path.join(current_dir, 'final', 'detections')
